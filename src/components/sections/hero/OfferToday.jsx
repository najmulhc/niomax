...
const OfferToday = () => {
  return (
    <div className="absolute md:bottom-0 right-4 bottom-4 md:-right-16 z-40 ">
      <div className="bg-yellow rounded-full flex justify-center items-center md:w-[7.5rem] md:h-[7.5rem] w-[4.5rem] h-[4.5rem] p-1  md:p-2 shadow-offer-shadow">
